...
const u8 gText_ExpandedPlaceholder_Archie[] = _("JIMMY");
const u8 gText_ExpandedPlaceholder_Maxie[] = _("SAM");
...
const u8 gText_PortaHealUsed[] = _("The whole party was fully healed!{PAUSE_UNTIL_PRESS}");
