...
#define BLASTOISE_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 105 : 85)
    ...
    [SPECIES_BLASTOISE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_TORRENT, ABILITY_NONE, ABILITY_PROTOSYNTHESIS },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_BUTTERFREE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_NONE, ABILITY_NO_GUARD },
...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_PIKACHU] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_SOLAR_POWER, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU, CONDITIONS({IF_PID_MODULO_100_LT, 50})}
                            #if P_ALOLAN_FORMS
                                ,{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU_ALOLA, CONDITIONS({IF_PID_MODULO_100_GT, 49})}
                            #endif
                            ),
    },
    ...
    [SPECIES_CLEFABLE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_MAGIC_GUARD, ABILITY_PLUS },
    #else
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_NONE, ABILITY_PLUS },
    #endif
        .bodyColor = BODY_COLOR_PINK,
        .noFlip = TRUE,
    ...
    [SPECIES_PRIMEAPE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 50, SPECIES_ANNIHILAPE}),
    #endif
    },
...
#define MAGNEMITE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_2 ? TYPE_STEEL : TYPE_ELECTRIC)
    ...
    [SPECIES_FARFETCHD_GALAR] =
    {
        ...
        .formSpeciesIdTable = sFarfetchdFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_SIRFETCHD}),
    },
...
#define GENGAR_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 75 : 130)
    ...
    #define GENGAR_ABILITIES {ABILITY_CURSED_BODY, ABILITY_NONE, ABILITY_MINUS}
#else
    #define GENGAR_ABILITIES {ABILITY_LEVITATE, ABILITY_NONE, ABILITY_MINUS}
#endif
    ...
    [SPECIES_EXEGGCUTE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR, CONDITIONS({IF_PID_MODULO_100_LT, 50})}
                            #if P_ALOLAN_FORMS
                                ,{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR_ALOLA, CONDITIONS({IF_PID_MODULO_100_GT, 49})}
                            #endif
                            ),
    },
    ...
    [SPECIES_CUBONE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_MAROWAK, CONDITIONS({IF_PID_MODULO_100_LT, 50})}
                            #if P_ALOLAN_FORMS
                                ,{EVO_LEVEL, 28, SPECIES_MAROWAK_ALOLA, CONDITIONS({IF_PID_MODULO_100_GT, 49}, {IF_TIME, TIME_NIGHT})},
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 43, SPECIES_LICKILICKY}),
    #endif
    },
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_WEEZING, CONDITIONS({IF_PID_MODULO_100_LT, 50})}
                            #if P_GALARIAN_FORMS
                                ,{EVO_LEVEL, 35, SPECIES_WEEZING_GALAR, CONDITIONS({IF_PID_MODULO_100_GT, 49})}
                            #endif
                            ),
    },
    ...
    #if P_GEN_2_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 43, SPECIES_BLISSEY}),
    #endif
    },
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 43, SPECIES_TANGROWTH}),
    #endif
    },
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_MR_MIME, CONDITIONS({IF_PID_MODULO_100_LT, 50})}
                            #if P_GALARIAN_FORMS
                                ,{EVO_LEVEL, 30, SPECIES_MR_MIME_GALAR, CONDITIONS({IF_PID_MODULO_100_GT, 49})}
                            #endif
                            ),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_SCYTHER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 43, SPECIES_SCIZOR, CONDITIONS({IF_PID_MODULO_100_LT, 50})},
                                {EVO_LEVEL, 43, SPECIES_KLEAVOR, CONDITIONS({IF_PID_MODULO_100_GT, 49})}),
    },
...
#define EEVEE_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 45 : 65)
    ...
    [SPECIES_ESPEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_SYNCHRONIZE, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_LEAFEON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_LEAF_GUARD, ABILITY_LEAF_GUARD, ABILITY_GRASSY_SURGE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_MUNCHLAX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_SNORLAX}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_SNORLAX] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_IMMUNITY, ABILITY_THICK_FAT, ABILITY_ANALYTIC },
        .bodyColor = BODY_COLOR_BLACK,
