...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_QUILAVA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_TYPHLOSION, CONDITIONS({IF_PID_MODULO_100_LT, 50})}
                            #if P_HISUIAN_FORMS
                                ,{EVO_LEVEL, 36, SPECIES_TYPHLOSION_HISUI, CONDITIONS({IF_PID_MODULO_100_GT, 49})}
                            #endif
                            ),
    },
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_BONSLY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 21, SPECIES_SUDOWOODO}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    #if P_GEN_4_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 43, SPECIES_AMBIPOM}),
    #endif
    },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_QWILFISH_HISUI] =
    {
        ...
        .formSpeciesIdTable = sQwilfishFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 43, SPECIES_OVERQWIL}),
    },
    ...
    [SPECIES_URSARING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 50, SPECIES_URSALUNA, CONDITIONS({IF_PID_MODULO_100_LT, 50})},
                                {EVO_LEVEL, 50, SPECIES_URSALUNA_BLOODMOON, CONDITIONS({IF_PID_MODULO_100_GT, 49})}),
    },
    ...
    [SPECIES_MANTYKE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 21, SPECIES_MANTINE}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    #if P_GEN_8_CROSS_EVOS
        .evolutions = EVOLUTION({EVO_LEVEL, 43, SPECIES_WYRDEER}),
    #endif
    },
    ...
    [SPECIES_WYRDEER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_FRISK, ABILITY_SLUSH_RUSH },
        .bodyColor = BODY_COLOR_GRAY,
