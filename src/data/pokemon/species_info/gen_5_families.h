...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_DEWOTT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_SAMUROTT, CONDITIONS({IF_PID_MODULO_100_LT, 50})}
                            #if P_HISUIAN_FORMS
                                ,{EVO_LEVEL, 36, SPECIES_SAMUROTT_HISUI, CONDITIONS({IF_PID_MODULO_100_GT, 49})}
                            #endif
                            ),
    },
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_PETILIL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT, CONDITIONS({IF_PID_MODULO_100_LT, 50})}
                            #if P_HISUIAN_FORMS
                                ,{EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT_HISUI, CONDITIONS({IF_PID_MODULO_100_GT, 49})}
                            #endif
                            ),
    },
    ...
    [SPECIES_BASCULIN_WHITE_STRIPED] =
    {
        ...
        .formSpeciesIdTable = sBasculinFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 50, SPECIES_BASCULEGION_M, CONDITIONS({IF_GENDER, MON_MALE})},
                                {EVO_LEVEL, 50, SPECIES_BASCULEGION_F, CONDITIONS({IF_GENDER, MON_FEMALE})}),
    },
    ...
    [SPECIES_DUCKLETT] =
    {
        ...
        .abilities = { ABILITY_KEEN_EYE, ABILITY_BIG_PECKS, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_BISHARP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 63, SPECIES_KINGAMBIT}),
    #endif
    },
    ...
    [SPECIES_RUFFLET] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 54, SPECIES_BRAVIARY, CONDITIONS({IF_PID_MODULO_100_LT, 50})}
                            #if P_HISUIAN_FORMS
                                ,{EVO_LEVEL, 54, SPECIES_BRAVIARY_HISUI, CONDITIONS({IF_PID_MODULO_100_GT, 49})}
                            #endif
                            ),
    },
    ...
    [SPECIES_ZWEILOUS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 63, SPECIES_HYDREIGON}),
    },
